...
class pascal_voc(object):
    def __init__(self, phase, rebulid=False):
    ...
    def get(self):
        ...
        labels = np.zeros(
            (self.batch_size, self.cell_size, self.cell_size, 6))   # 为5+类别数
        count = 0
    ...
    def image_read(self, imname, flipped=False):
        ...
        data_path = os.path.join(PROJECT_ROOT, imname)
    ...
    def load_pascal_JPEGImages_annotation(self, index):
        ...
        # data/VOCdevkit/VOC2007/JPEGImages存放原图片
        # imname为训练样本路径
        ...
        # label = np.zeros((self.cell_size, self.cell_size, 25))   # 为5+类别数
