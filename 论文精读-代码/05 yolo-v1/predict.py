...
class Detector(object):
    def __init__(self, net, weight_file):
        ...
        # 加载权重
        # self._load_weights('./data/pascal_voc/output/2019_07_19_14_29/yolo-15000')
        self._load_weights('./data1/pascal_voc/output/2019_12_08_12_28/yolo-3000')
...
def main():
    ...
    # image_file = 'test/009960.jpg'
    image_file = 'test/1_609.jpg'
